...
base_path = r"C:\Users\beste\OneDrive - Qral Group\01 Narcan\12 Ops\20231207 - mdm working\02 Internal Controls"
...
base_output_filename = 'Customer_mastering_output'


#base name for the output file
output_filename= f"{base_output_filename}_Spec_Distributers_Fuzzy_TEST_{current_time_suffix}.csv"
...
def readData(filename, dropped_file=None):
    ...
    with open(filename, encoding=encoding ) as f:
        ...
        for i, row in enumerate(reader):
            ...
            if filename.endswith ('SFDC Accounts Extract 20231207_145640_v2.csv') and not clean_row.get('ShippingStreet'):
                continue
            elif filename.endswith('Processed__SpecDist Mastering Input20231208.csv'):
...
if __name__ == '__main__':
    ...
    left_file = os.path.join(base_path, 'SFDC Accounts Extract 20231207_145640_v2.csv') # Set path folder Internal Controls, e.g., C:\Users\beste\OneDrive - Qral Group\01 Narcan\12 Ops\20231122 - dashboard dev\02 Internal Controls
    right_file = os.path.join(base_path, Procossed_input_subdirectory, 'Processed__SpecDist Mastering Input20231208.csv') # Set path folder Internal Controls,
        ...
        for fileno, filename in enumerate((left_file, right_file)):
            ...
            with open(filename, 'r', encoding=file_encoding, errors='replace') as f_input:
                ...
                if header_unwritten:
                    ...
                    predefined_fieldnames = ['Cluster ID', 'Link Score', 'MDM ID', 'Dedupe_Set_confidence_score', 'Dedupe_Set_Cluster ID','source file', 'Id', 'Name', 'Address', 'City', 
