...
#base name for the output file
output_filename= f"{base_output_filename}_ExFactory_Fuzzy_RESULT_{current_time_suffix}.csv"
...
if __name__ == '__main__':
    ...
    left_file = os.path.join(base_path, 'SFDC Accounts Extract 20231207_145640_v2.csv') # Set path folder Internal Controls, e.g., C:\Users\beste\Qral Group\066.0001 Contract Operations Process Management - 12 Ops\20231103\02 Internal Controls
    right_file = os.path.join(base_path, Procossed_input_subdirectory, 'Processed__ExFactory Mastering Input20231208.csv') # Set path folder Internal Controls,
    
    # Define the path for the file to store dropped rows
    dropped_rows_file = os.path.join(base_path, output_subdirectory, f'Customer_mastering_output_ExFactory - LOG unusable records_{current_time_suffix}.csv')
