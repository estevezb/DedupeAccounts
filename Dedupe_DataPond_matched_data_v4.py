...
base_path = r"C:\Users\beste\OneDrive - Qral Group\01 Narcan\12 Ops\20231128_A1\02 Internal Controls"
...
base_output_filename = 'Dedupped_'

#base name for the output file
output_filename = f"{base_output_filename}_SpecDist Mastering Input20231128_175947.csv"
...
if __name__ == '__main__':
    ...
    input_file = os.path.join(base_path,subdirectory, 'Processed__SpecDist Mastering Input20231128_175947.csv')
    output_file = os.path.join(base_path, output_subdirectory,output_filename)
    settings_file = 'data_matching_learned_settings_Dedup_SpecDistr_20231201' # Do not need this when run first time on your own data (can delete if exists, or if you want to repeat or add to the training file)
    training_file = 'data_matching_training_Updated_Dedup_SpecDistr_20231201' # Change if needed to the relevant training file for the input data
